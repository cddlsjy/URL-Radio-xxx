...
**URL Radio is free software. 原版只能用于Android6.0（编译设置minisdk=19就可以android5机器上运行）,It is released under the [MIT open source license](https://opensource.org/licenses/MIT).**
</div>
